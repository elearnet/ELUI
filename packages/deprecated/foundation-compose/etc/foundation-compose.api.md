## API Report File for "@eluifabricshared/foundation-compose"
...
import { IComponentTokens } from '@eluifabricshared/foundation-tokens';
import { IComposableDefinition } from '@eluifabricshared/foundation-composable';
import { INativeSlotType } from '@eluifabricshared/foundation-composable';
import { IOverrideLookup } from '@eluifabricshared/foundation-settings';
import { IRenderData } from '@eluifabricshared/foundation-composable';
import { ISettingsEntry } from '@eluifabricshared/themed-settings';
import { ISlotProps } from '@eluifabricshared/foundation-settings';
import { ISlotStyleFactories } from '@eluifabricshared/foundation-tokens';
import { ISlotWithFilter } from '@eluifabricshared/foundation-composable';
